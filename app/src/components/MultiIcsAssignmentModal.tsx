...
export default function MultiIcsAssignmentModal({
  ...
  const [splitAndAssignICS, { loading: splitLoading }] = useMutation(
    SPLIT_AND_ASSIGN_ICS,
    {
      refetchQueries: [{ query: GET_ALL_INSPECTION_ACCEPTANCE_REPORT_FOR_ICS }],
    },
        ...
        {tabIndex === 2 && (
          <Stack spacing={2}>
            <Alert severity="info" sx={{ mb: 1 }}>
              ...
              split gets its own ICS ID. You can split into any number of pieces
              (e.g. 1 lot → 6 ICS assignments). All splits are tracked back to
                    ...
                    >
                      <Box>
                        ...
                        <Typography variant="caption" color="text.secondary">
                          Each split gets its own ICS ID. All splits are tracked
