...
export default function InspectionAcceptanceForReporting({
  signatories,
  reportData,
  onPrint,
  onClose,
          ...
          <Table sx={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <TableBody>
              {itemsArray?.length > 0 ? (
                itemsArray.map((item: any, index: any) => (
                  <StyledTableRow key={index}>
                    ...
                    <StyledTableCell colSpan={3}>{item.description}</StyledTableCell>
              ...
              <StyledTableRow>
                ...
                <StyledTableCell>{formatTotalAmount}</StyledTableCell>
              </StyledTableRow>
                      ...
                      >
                        <Box
                          sx={{
                            ...
                            border: '1px dotted black',
                            backgroundColor:
                              itemsArray[0]?.PurchaseOrder?.status === 'complete'
                                ? '#ccc'
                                : 'transparent',
                          }}
                        ></Box>
