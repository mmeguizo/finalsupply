                  ...
                  {(poIncome || poMds || poDetails) && (
                    <StyledTableRow>
                      ...
                      <StyledTableCell colSpan={2} sx={{ textAlign: 'left', padding: 0.5 }}>
                        {poIncome && <Typography fontSize={12}>Income: {poIncome}</Typography>}
                        {poMds && <Typography fontSize={12}>MDS: {poMds}</Typography>}
                        {poDetails && <Typography fontSize={12}>Details: {poDetails}</Typography>}
                      </StyledTableCell>
                      <StyledTableCell></StyledTableCell>
                      <StyledTableCell></StyledTableCell>
                    </StyledTableRow>
