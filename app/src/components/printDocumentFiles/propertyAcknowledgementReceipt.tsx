  ...
  <div class="page">
    <table>
      ...
      <tfoot>
        ...
        <tr>
          <td colspan="4" style="padding: 4px; vertical-align: top;">Remarks: ${remarks || firstItem?.remarks ? `<span style="font-style: italic;">${nl2br(escapeHtml(remarks || firstItem?.remarks || ''))}</span>` : ''}${firstItem?.details ? `<br/><span style="font-style: italic;">${nl2br(escapeHtml(firstItem.details))}</span>` : ''}${firstItem?.poRemarks ? `<br/><span style="font-style: italic;">${nl2br(escapeHtml(firstItem.poRemarks))}</span>` : ''}</td>
