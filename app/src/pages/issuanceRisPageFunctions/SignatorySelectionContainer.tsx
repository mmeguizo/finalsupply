...
const SignatoriesComponent = ({ signatories, onSignatoriesChange }: RisPageProps) => {
  ...
  const handleSignatoryChange = (
    role: keyof risIssuanceSignatories,
    newValue: UserOption | string | null
  ) => {
    let fullName = '';
    if (!newValue) {
      fullName = '';
  ...
  const signatoryRoles = [
    {
      key: 'requested_by' as keyof risIssuanceSignatories,
      label: 'Requested By',
      designation: 'End User',
    },
    {
      key: 'approved_by' as keyof risIssuanceSignatories,
      label: 'Approved By',
      designation: 'AO V / Supply Officer',
    },
    {
      key: 'issued_by' as keyof risIssuanceSignatories,
      label: 'Issued By',
      designation: 'Supply Officer Staff',
    },
    {
      key: 'recieved_by' as keyof risIssuanceSignatories,
      label: 'Received By',
      designation: 'End User',
    },
  ];
